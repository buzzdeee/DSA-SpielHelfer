...
#ifndef _DSAACTIONCHOICEQUESTIONCONTROLLER_H_
#define _DSAACTIONCHOICEQUESTIONCONTROLLER_H_

#import <AppKit/AppKit.h>

@interface DSAActionChoiceQuestionController : NSWindowController
...
@property (nonatomic, weak) IBOutlet NSPopUpButton *popupChoice;
