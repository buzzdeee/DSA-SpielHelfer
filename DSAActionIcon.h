...
@end
@interface DSAActionIconChangeRoute: DSAActionIconClickTarget
@end
...
@end
@interface DSAActionIconGuardSelection: DSAActionIconClickTarget
@end
@interface DSAActionIconCollectHerbs: DSAActionIconClickTarget
@end
